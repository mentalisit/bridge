...
func (b *Bridge) logicMessage() {
	...
	if lenChannels > 0 {
		wg.Add(lenChannels)
		b.discord.SendBridgeAsync(b.in.Text, b.GetSenderName(), chatIdsDS, b.in.FileUrl, b.in.Avatar, b.in.Reply, resultChannelDs, &wg)
	}
...
func (b *Bridge) sendTg(chatIdsTG []string, resultChannelTg chan<- models.MessageTg, wg *sync.WaitGroup) {
	...
	if b.in.Reply != nil && (b.in.Reply.FileUrl != "" || b.in.Reply.Text != "") {
		...
		go b.telegram.SendBridgeAsync(chatIdsTG, textTg, b.in.Reply.FileUrl, resultChannelTg, wg)
	} else {
		go b.telegram.SendBridgeAsync(chatIdsTG, textTg, b.in.FileUrl, resultChannelTg, wg)
	}
}
